  ...
  async function loadData({ skipSilentSync = false } = {}) {
    ...
    try {
      ...
      const [
        ...
        safeLoad("pacotes pr̩-pagos", () => (RecurringPackage.listAll ? RecurringPackage.listAll("-created_at", 1000, 10000) : RecurringPackage.list("-created_at", 5000)), []),
        ...
        safeLoad("cr̩ditos de pacotes", () => (PackageCredit.listAll ? PackageCredit.listAll("-created_at", 1000, 20000) : PackageCredit.list("-created_at", 5000)), []),
        safeLoad("cobran̤as de pacotes", () => (PackageBilling.listAll ? PackageBilling.listAll("-created_at", 1000, 20000) : PackageBilling.list("-created_at", 5000)), []),
        User.me().catch(() => null),
      ]);
