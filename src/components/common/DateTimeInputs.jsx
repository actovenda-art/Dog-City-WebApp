...
const calendarClassNames = {
  ...
  month: "w-[236px] space-y-2",
  caption: "grid min-h-[36px] grid-cols-[28px_1fr_28px] items-center gap-1.5 px-0 pt-0",
  caption_dropdowns: "col-start-2 flex min-w-0 items-center justify-center gap-2",
  caption_label: "inline-flex min-h-8 items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3 text-[13px] font-semibold leading-none text-slate-900 capitalize shadow-sm",
  nav: "contents",
  ...
  dropdown_month: "relative w-[118px]",
  dropdown_year: "relative w-[86px]",
  dropdown_icon: "h-3.5 w-3.5 text-slate-400",
  table: "mt-1 w-full table-fixed border-collapse",
  head_row: "flex w-full justify-between",
  head_cell: "flex h-8 w-8 items-center justify-center text-center text-[10px] font-semibold uppercase tracking-[0.08em] text-slate-400",
  row: "mt-1 flex w-full justify-between",
  cell: "h-8 w-8 p-0 text-center text-[13px]",
  day: "h-8 w-8 rounded-full p-0 text-[14px] font-semibold leading-none text-slate-700 hover:bg-slate-100 hover:text-slate-900",
