              ...
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {renderTextField({
                    ...
                    onChange: (e) => setCarteiraForm({ ...carteiraForm, nome_razao_social: sanitizeDisplayNameInput(e.target.value) }),
                    onBlur: () => setCarteiraForm({ ...carteiraForm, nome_razao_social: formatDisplayName(carteiraForm.nome_razao_social) }),
