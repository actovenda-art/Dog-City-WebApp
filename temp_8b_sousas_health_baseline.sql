select
  ...
  (select count(*) from public.reconciliacao_financeira rf where rf.empresa_id = '992c8aa3-8c11-44a6-87fc-0346725f4980' and coalesce(rf.status, '') in ('divergente','erro')) as reconciliacoes_divergentes;
